...
@plugin.command
@lightbulb.command('tmr', "Tells you if tomorrow is an A day or B day.")
...
async def user_data(ctx):
    ...
    print(f"User has requested: {tomorrow}")

    date = checkDay(str(tomorrow))
